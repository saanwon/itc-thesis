...
//
    ...
    if (err != CL_SUCCESS)
    {
        printf("Error(%d): Failed to get device Info (CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS)!\n",
                                                                            err_code(err));
        return EXIT_FAILURE;
    }
    ...
    if (err != CL_SUCCESS)
    {
        printf("Error(%d): Failed to get device Info (CL_DEVICE_MAX_WORK_ITEM_SIZES)!\n",err_code(err));
        return EXIT_FAILURE;
    }
    ...
    if (err != CL_SUCCESS)
    {
        printf("Error(%d): Failed to get device Info (CL_DEVICE_MAX_WORK_GROUP_SIZE)!\n",err_code(err));
        return EXIT_FAILURE;
    }
